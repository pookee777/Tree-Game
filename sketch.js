...
var gainSound,loseSound;
var winSound;
function preload()
{  
  backImg = loadImage("background.jpg");
  back1Img = loadImage("bg.jpg");
  ...
  gainSound = loadSound("zoom.mp3");
  loseSound = loadSound("zoom1.mp3");
  winSound = loadSound("zoom2.mp3");
}
...
function setup() 
{
  ...
  world = engine.world;
  back1 = createSprite(width/1.3,height/2,width,height);
  back1.addImage("back",backImg);
  back1.visible = false;
  back1.velocityX = -4;
